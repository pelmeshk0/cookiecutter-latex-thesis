...
\linespread{1.4} % Definition of the linespread
...
%pdfauthor={{Radomskyi Maksym}}, % Optional: Specify the author of the pdf
%pdftitle={{Extending CoBundleMAP for the analysis of fiber-specific metrics}}   % Optional: Specify the title within the pdf
} 
